locals {
  ...
  event_bridge_policy_name = "${local.base_name}-eventBridge-policy"
  event_bridge_role_name = "${local.base_name}-eventBridge-role"
  event_bridge_policy_attachment = "${local.base_name}-eventBridge-policy-attachment"
